            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12">
                    ...
                    <Select
                        ...
                        filter
                    />
                    <small v-if="submitted && !reception.engine_id" class="text-red-500">
                ...
                <div class="col-span-12">
                    ...
                    <Select
                        ...
                        filter
                    />
                    <small v-if="submitted && !reception.customer_owner_id" class="text-red-500">
                        Obligatorio.
                    </small>
                </div>
                ...
                <div class="col-span-12">
                    ...
                    <Select
                        ...
                        filter
                    />
                    <small v-if="submitted && !reception.customer_contact_id" class="text-red-500">
                        Obligatorio.
                    </small>
                </div>
                ...
                <div class="col-span-12">
                    ...
                    <Textarea
                        v-model="reception.problema"
                        rows="4"
                        class="w-full mt-1"
                        placeholder="Describa el problema del motor..."
                    />
                    <small v-if="submitted && !reception.problema" class="text-red-500">
            ...
            />
                ...
                <div class="col-span-12">
                    ...
                    <div v-if="recordedAudios.length" class="mt-3 space-y-3">
                        <div
                            v-for="(audio, index) in recordedAudios"
                            :key="index"
                            class="p-3 border rounded bg-gray-50"
                        >
                            <label class="font-semibold">Audio {{ index + 1 }}</label>

                            <audio :src="getAudioUrl(audio)" controls class="w-full mt-2"></audio>
                ...
                <div class="col-span-12">
                    ...
                    <Calendar
                        v-model="reception.fecha_ingreso"
                        showTime
                        hourFormat="24"
                        class="w-full mt-1"
                    />
                    <small v-if="submitted && !reception.fecha_ingreso" class="text-red-500">
